...
// used properly, this model can help achieve reliability between the
// data persisted on database and the jobs that should rely upon it.
//
// Being Faktory and Postgres two separate external systems, failures and
...
//
// The PendingJob model can be used as an additional supportive record to
// increase reliability and reduce the downsides of both scenarios depicted
// above.
//
